  ApplicationId = "com.CompassSolutions.ProjectV" --be sure to change this!
  AppName = "ProjectV"
  CompanyName = "Compass Solutions, Inc."
  LuaSrc = "C:\\Compass64\\moai\\Pong"
  HostSettings = {
    ["android-gradle"] = {
       SdkDir = "D:\\MOAI-Stuff\\Android",
       NdkDir = "D:\\MOAI-Stuff\\android-ndk-r8e",
